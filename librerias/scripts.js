...
/*######################################
 * #####################################
 * FUNCIONES CREADAS POR OPUS LIBERTATI#
 *###################################### 
 *######################################
 */

function cambiarEstadoSolicitudAutorizacion(opcion , idsolicitud){
	if (confirm("Esta acción no se podra revertir \n ¿Esta seguro que desea "+opcion+" la solicitud?")) {
			$("#tdautorizacion"+idsolicitud).load("librerias/funcionesOpus?req=autorizaciones&opcion="+opcion+"&id="+idsolicitud);
		}
}
