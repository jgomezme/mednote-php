...
$link=Conectarse(); 
?>
<h2>Direcci&oacute;n <? echo $tipo; ?></h2>
...
<sup><font color="00ff00">1</font></sup><select name="id_geo_tipo_via_<? echo $tipo; ?>" size="0">
...
<sup><font color="00ff00">2</font></sup><select name="id_geo_tipo_via_extra_<? echo $tipo; ?>" size="0">
...
<sup><font color="00ff00">3</font></sup><select name="id_geo_numero_01_<? echo $tipo; ?>" size="0">
<option value="" selected > </option>
<?
for ($i=0;$i<=350;$i++)
{        
...
<sup><font color="00ff00">4</font></sup><select name="letra_01_<? echo $tipo; ?>">
<option value="" selected > </option>
...
<sup><font color="00ff00">5</font></sup><select name="letra_03_<? echo $tipo; ?>">
<option value="" selected > </option>
<option value="bis">bis</option>
...
<sup><font color="00ff00">7</font></sup><select name="geo_separador_<? echo $tipo; ?>" size="0">
...
<sup><font color="00ff00">8</font></sup><select name="id_geo_numero_02_<? echo $tipo; ?>" size="0">
<option value="" selected > </option>
<?
for ($i=0;$i<=350;$i++)
{        
...
<sup><font color="00ff00">9</font></sup><select name="letra_02_<? echo $tipo; ?>">
<option value="" selected > </option>
<option value="bis">bis</option>
...
-
<sup><font color="00ff00">10</font></sup><select name="id_geo_numero_03_<? echo $tipo; ?>" size="0">
<option value="" selected > </option>
<?
for ($i=0;$i<=350;$i++)
{        
...
<sup><font color="00ff00">12</font></sup><select name="id_geo_hito_01_<? echo $tipo; ?>" size="0">
<option value="" selected > </option>
<?php 
mysql_query ("SET NAMES 'utf8'");
...
<sup><font color="00ff00">13</font></sup><input type="text" name="hito_01_<? echo $tipo; ?>" id="hito_01_<? echo $tipo; ?>" value="">
 
<sup><font color="00ff00">14</font></sup><select name="id_geo_hito_02_<? echo $tipo; ?>" size="0">
<option value="" selected > </option>
<?php 
mysql_query ("SET NAMES 'utf8'");
if ($geo_hito_via != ""){$Geo_hito_definido=mysql_query("SELECT * FROM geo_hitos WHERE id_geo_hito = $geo_hito",$link); 
...
<sup><font color="00ff00">15</font></sup><input type="text" name="hito_02_<? echo $tipo; ?>" id="hito_02_<? echo $tipo; ?>" value="">
<br>
<sup><font color="00ff00">16</font></sup><select name="id_geo_hito_03_<? echo $tipo; ?>" size="0">
<option value="" selected > </option>
<?php 
mysql_query ("SET NAMES 'utf8'");
if ($geo_hito_via != ""){$Geo_hito_definido=mysql_query("SELECT * FROM geo_hitos WHERE id_geo_hito = $geo_hito",$link); 
...
<sup><font color="00ff00">17</font></sup><input type="text" name="hito_04_<? echo $tipo; ?>" id="hito_04_<? echo $tipo; ?>" value=""><br>
<sup><font color="00ff00">18</font></sup><select name="id_geo_hito_04_<? echo $tipo; ?>" size="0">
<option value="" selected > </option>
<?php 
mysql_query ("SET NAMES 'utf8'");
if ($geo_hito_via != ""){$Geo_hito_definido=mysql_query("SELECT * FROM geo_hitos WHERE id_geo_hito = $geo_hito",$link); 
...
<sup><font color="00ff00">19</font></sup><input type="text" name="hito_04_<? echo $tipo; ?>" id="hito_04_<? echo $tipo; ?>" value="">
<br>
<? } ?><?php
