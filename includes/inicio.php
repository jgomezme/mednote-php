...
$perfil=mysql_query("SELECT * FROM d9_users WHERE id= $id_usuario AND p_nombre IS NOT NULL ",$link);
...
if (mysql_num_rows($consulta_licencia)=='0'){
	...
	echo "<div align='center'><img src='images/logo.gif'  border='0' alt='GaleNUx-praxis'>
	<br>
...
$Usuario_Datos=mysql_query("SELECT * FROM d9_users  WHERE  (id =  '$id_usuario')",$link); 
...
$fecha_nacimiento == "";
			...
			<div align='center'><img src='images/logo.gif'  border='0' alt='GaleNUx-praxis'><br>
				<font size=''>
...
?>
  ...
  <tr>
   <td style=" text-align: left; vertical-align: top; width: 150;" >
        ...
        <tr>
        	<td><img src="images/logo.gif"  border="0" alt="GaleNUx-praxis">
<?
