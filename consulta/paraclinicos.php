...
$ayuda = "<h2>Paraclínicos y otras ayudas diagnosticas que trae el usuario</h2>
...
<input onclick=\"xajax_grabar_ayudas(xajax.getFormValues('consulta'))\" value='Grabar paraclínicos' type='button'>
