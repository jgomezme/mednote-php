...
<form name='imprimir_medicamentos' id='imprimir_medicamentos'>
...
$nuevo_select .= "<li><input type='checkbox' id='receta[".$row['id_receta']."]' name='receta[".$row['id_receta']."]' onchange= \"xajax_impresion_medicamentos(xajax.getFormValues('imprimir_medicamentos')); \" > ".$row['medicamento_nombre']." ";
