...
$nuevo_select .= "<table border='0'><tr valign='top'><td><img src='../images/logo_impresion.gif' alt='$_SESSION[razon_social]'></td><td>";
echo $nuevo_select;
...
$sql=mysql_query("
					...
					AND consulta_tipo_campos.tipo_consulta = '3'
...
if($imprimir=='1'){
$nuevo_select .= "<li>" .$row['campo_nombre'] . ":<b> $contenido</b></li>";
