...
$correo_destino = mysql_query("select email from d9_users where id = $id ",$link);
$correo_destino = mysql_fetch_array($correo_destino);
$correo_funcionario = mysql_query("select email from d9_users where id = $funcionario ",$link);
