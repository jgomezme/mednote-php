...
<tr>
<td><input type="text" name="email" id="email"  size="25" value="<? echo $email; ?>"></td>
<td><input type="text"  name="email_2" id="email_2" size="25" value="<? echo $email; ?>"></td>
</tr>
<tr><td></td><td><input type="hidden" value="<?php echo $formulario ?>" id="formulario" name="formulario">
