...
$headers .= "From: Revista el malpensante < amigos@elmalpensante.net >\r\n";
...
VALUES (
NULL , '$hora', NULL , '$asunto_correo', 'Enviado a: $correo_destinatario Desde: $correo_funcionario ---------------------------------------- $cuerpo_correo','$id', '$funcionario', 'email', '', '0'
)",$link);
